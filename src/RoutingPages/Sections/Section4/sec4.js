...
export default function Section4() {
  return (
    <div className='mt-[11.5rem] lg:mt-[3rem] md:relative md:top-[-13rem] '>
      <div className='mt-[18rem]'>
        <Paragraphe title={"The great players in the Moroccan National Team"} />
      </div>
      <br className='hidden lg:flex'/>
      <div className='flex flex-col gap-5 justify-center items-center
      lg:flex-row  lg:w-full  lg:gap-2 
      md:justify-center md:align-center w-screen 
      '>
        <div className=' md:flex md:flex-row gap-2 '> 
        <img src="section44/ziach.jpeg" alt="" className='w-[15rem] h-[18rem] lg:w-[18rem] lg:h-[20rem]'/>
        <br className='lg:hidden'/>
        <img src="section44/hakimi.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[18rem] lg:h-[20rem]'/>
        </div>
        <div className=' md:flex md:flex-row md:gap-2'>
        <img src="section44/bono.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[18rem] lg:h-[20rem]'/>
        <br className='lg:hidden'/>

        <img src="section44/saiss.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[18rem] lg:h-[20rem]'/>
        </div>
        <img src="section44/nsiri.jpeg" alt="" className='w-[15rem] h-[18rem] lg:w-[18rem] lg:h-[20rem]'/>
      </div>
